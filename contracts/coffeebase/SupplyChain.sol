...
contract SupplyChain is RetailerRole, FarmerRole, DistributorRole, ConsumerRole {
    ...
    // Define a function 'tagItem' that allows the retailer to change an item price
    // Use the above modifiers to check if the item is received
    function tagItem(uint _upc, uint price) public
        // Call modifier to check if upc has passed previous supply chain stage
        received(_upc)
        // Access Control List enforced by calling Smart Contract / DApp
        onlyRetailer
    ...
    // Use the above modifiers to check if the item is tagged
